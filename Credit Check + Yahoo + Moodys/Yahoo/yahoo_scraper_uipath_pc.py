...
def yahoo_scraper_func(file_name):
    ...
    df.to_excel('C:\\Users\\danie\\Desktop\\Master Template Credit {}.xlsx'.format(datetime.datetime.now().strftime("%d_%m_%y %H_%M_%S"), index = False))