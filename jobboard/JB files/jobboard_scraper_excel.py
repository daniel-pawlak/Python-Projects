...
class JobboardScraper:
    def __init__(self, country, jobboard, currency):
        self.skills_path = r'C:\Users\danie\Desktop\Python\Scrapers\jobboard\skills.txt'
        self.db_config_path = r'C:\Users\danie\Desktop\Python\Scrapers\jobboard\db_config.json'
        self.locations_path = r'C:\Users\danie\Desktop\Python\Scrapers\jobboard\locations.json'
        self.companies_sectors_map_path = r'C:\Users\danie\Desktop\Python\Scrapers\jobboard\companies_sectors_map.json'
        self.companies_sectors_linkedin_path = r'C:\Users\danie\Desktop\Python\Scrapers\jobboard\companies_sectors_linkedin_shaved.json'
        self.isco_jobtitles_en_path = r'C:\Users\danie\Desktop\Python\Scrapers\jobboard\isco_jobtitles_en.json'
        self.isco_jobtitles_de_fr_it_path = r'C:\Users\danie\Desktop\Python\Scrapers\jobboard\isco_jobtitles_de_fr_it.json'
    ...
    def __salary_pro_hr_and_timeframe(self, salary, salary_max, salary_min, hours_per_year, hours_per_month, hours_per_week, hours_per_day):
    ...
    def __parse_salary(self, salary, employment_type, full_description, link, hours_per_year=2080, hours_per_month=170, hours_per_week=40, hours_per_day=8):
        ...
        salary_timeframe, salary_in_eur_per_hour_max, salary_in_eur_per_hour_min = self.__salary_pro_hr_and_timeframe(salary, salary_max, salary_min, hours_per_year, hours_per_month, hours_per_week, hours_per_day)
    ...
    def map_sector(self, sector_input):
        ...
        return None
    total = []
    def export_to_excel(self, title, company_name, location_jobboard, posting_date, sector_jobboard, salary, agency_or_direct, employment_type, full_description, skills, link, advanced_skill_search=False, check_if_exists=False):
    # def export_to_database(self, title, company_name, location_jobboard, posting_date, sector_jobboard, salary, agency_or_direct, employment_type, full_description, skills, link, other, advanced_skill_search=False, check_if_exists=False):
        print('nigga')
        # total = []
