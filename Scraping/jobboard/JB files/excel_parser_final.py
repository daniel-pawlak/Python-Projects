...
wb = load_workbook(r'C:\Users\danie\Desktop\Python\Scrapers\jobboard\SelectedCompanies - Top 50.xlsx')
...
for i in range(1, max_row + 1): 
    full_description = sheet_obj.cell(row = i, column = 13).value   # 13 for M column
    skills = ''
